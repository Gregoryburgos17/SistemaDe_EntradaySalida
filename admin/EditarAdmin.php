                ...
                Calendario
                  ...
                  <form method="POST">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="id_em" value="<?php echo $_POST['id_empleado']?>">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="pass"value="<?php echo $_POST['pass']?>">
                      </div>
