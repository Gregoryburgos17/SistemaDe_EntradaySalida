        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="personal.html">
              ...
              <tbody>
                ...
                foreach($data as $dato){
                  ...
                  if($dato['estado']!=0){
                    ...
                    else{echo"<td class='table-danger'>inactivo</td>";}
                  echo"
              ...
              <div class="modal-body">
                  <form method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="recipient-name" name="fechan">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="huella">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="direccion1">
                      </div>
                      <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Direcccion #2</label>
                        <input type="text" class="form-control" id="recipient-name" name="direccion2">
                      </div>
                      <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Puesto</label>
                        <input type="text" class="form-control" id="recipient-name" name="puesto">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="recipient-name" name="fechae">
                      </div>
